""" problem011.py:
        Find the row, column, or diagonal with 4 adjacent digits with the
        highest product.
"""
...
my_arr = ([[8,2,22,97,38,15,0,40,0,75,4,5,7,78,52,12,50,77,91,8],
    ...
    for row_index, row in enumerate(arr):
        for column_index in range(17):
            ...
            if candidate > current_max:
                ...
                pass
    # Correctness and intuition-aiding.
    assert(current_max == reduce(mul, (arr[x_value][y_value + n] for n in range(4))))
